...
#[educe(Debug, Clone)]
#[must_use]
pub struct QuadExtVar<BF: FieldVar<P::BaseField, CF>, P: QuadExtVarConfig<BF, CF>, CF: PrimeField>
where
...
/// `QuadExtVar`.
pub trait QuadExtVarConfig<BF: FieldVar<Self::BaseField, CF>, CF: PrimeField>:
    QuadExtConfig
where
    ...
    for<'a> &'a BF: FieldOpsBounds<'a, P::BaseField, BF>,
{
    ...
    where
        Self: FieldVar<QuadExtField<P>, CF>,
    {
...
impl<BF, P, CF> R1CSVar<CF> for QuadExtVar<BF, P, CF>
where
...
impl<BF, P, CF> From<Boolean<CF>> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'a> &'a BF: FieldOpsBounds<'a, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl<'a, BF, P, CF> FieldOpsBounds<'a, QuadExtField<P>, QuadExtVar<BF, P, CF>>
    for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
...
impl<BF, P, CF> FieldVar<QuadExtField<P>, CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'a> &'a BF: FieldOpsBounds<'a, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl_bounded_ops!(
    ...
    AddAssign,
    add_assign,
    |this: &'a QuadExtVar<BF, P, CF>, other: &'a QuadExtVar<BF, P, CF>| {
    ...
    (BF: FieldVar<P::BaseField, CF>, P: QuadExtVarConfig<BF, CF>, CF: PrimeField),
    for <'b> &'b BF: FieldOpsBounds<'b, P::BaseField, BF>
);
impl_bounded_ops!(
    QuadExtVar<BF, P, CF>,
...
impl<BF, P, CF> EqGadget<CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'b> &'b BF: FieldOpsBounds<'b, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl<BF, P, CF> ToBitsGadget<CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'b> &'b BF: FieldOpsBounds<'b, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl<BF, P, CF> ToBytesGadget<CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'b> &'b BF: FieldOpsBounds<'b, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl<BF, P, CF> ToConstraintFieldGadget<CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'a> &'a BF: FieldOpsBounds<'a, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl<BF, P, CF> CondSelectGadget<CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'b> &'b BF: FieldOpsBounds<'b, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
...
impl<BF, P, CF> TwoBitLookupGadget<CF> for QuadExtVar<BF, P, CF>
where
...
impl<BF, P, CF> ThreeBitCondNegLookupGadget<CF> for QuadExtVar<BF, P, CF>
where
...
impl<BF, P, CF> AllocVar<QuadExtField<P>, CF> for QuadExtVar<BF, P, CF>
where
    BF: FieldVar<P::BaseField, CF>,
    for<'b> &'b BF: FieldOpsBounds<'b, P::BaseField, BF>,
    P: QuadExtVarConfig<BF, CF>,
